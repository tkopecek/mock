...
The solution is to use mock's [bootstrap feature](https://rpm-software-management.github.io/mock/Release-Notes-1.4.1#bootstrap-chroot). It is enabled by default, but there are still some [unresolved issues](https://github.com/rpm-software-management/mock/labels/bootstrap). Generally it works. Try following if you've it disabled from some reason:
